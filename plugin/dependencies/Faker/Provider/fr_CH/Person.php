...
namespace AIKit\Dependencies\Faker\Provider\fr_CH;

class Person extends \AIKit\Dependencies\Faker\Provider\fr_FR\Person
{
    /**
    ...
    public static function avs13()
    {
        ...
        $checksum = \AIKit\Dependencies\Faker\Calculator\Ean::checksum(implode('', $p));
