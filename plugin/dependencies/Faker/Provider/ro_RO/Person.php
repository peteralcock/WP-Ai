...
namespace AIKit\Dependencies\Faker\Provider\ro_RO;

class Person extends \AIKit\Dependencies\Faker\Provider\Person
{
    ...
    protected function getDateOfBirth($dateOfBirth)
    {
        ...
        $baseDate = \AIKit\Dependencies\Faker\Provider\DateTime::dateTimeBetween("first day of January {$dateOfBirthParts[0]}", "last day of December {$dateOfBirthParts[0]}");
