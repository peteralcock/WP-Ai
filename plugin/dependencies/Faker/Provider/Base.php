...
use AIKit\Dependencies\Faker\DefaultGenerator;
use AIKit\Dependencies\Faker\Extension;
use AIKit\Dependencies\Faker\Generator;
use AIKit\Dependencies\Faker\UniqueGenerator;
use AIKit\Dependencies\Faker\ValidGenerator;

class Base
{
    /**
     * @var \AIKit\Dependencies\Faker\Generator
     */
    protected $generator;

    /**
     * @var \AIKit\Dependencies\Faker\UniqueGenerator
     */
    protected $unique;
