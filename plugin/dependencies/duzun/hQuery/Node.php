<?php
namespace AIKit\Dependencies\duzun\hQuery;

use AIKit\Dependencies\duzun\hQuery\Parser\Selector as SelectorParser;
use AIKit\Dependencies\duzun\hQuery\Parser\HTML as HTMLParser;
...
abstract class Node implements \Iterator, \Countable
{
    ...
    // ------------------------------------------------------------------------
    /**
     * @var AIKit\Dependencies\duzun\hQuery\Node
     */
    ...
    /**
     * Parent doc
     * @var AIKit\Dependencies\duzun\hQuery
     */
    protected $doc;
     ...
     *
     * @return AIKit\Dependencies\duzun\hQuery
     */
    public function doc()
    {
...
// - Helpers ------------------------------------------------
    ...
    // ------------------------------------------------------------------------
    /**
     * Use AIKit\Dependencies\duzun\hQuery\Parser::str_range() instead
     *
     * @deprecated
     *
     * @param $comp
...
// ------------------------------------------------------------------------
// PSR-0 alias
class_exists('hQuery_Node', false) or class_alias('AIKit\Dependencies\duzun\\hQuery\\Node', 'hQuery_Node', false);
