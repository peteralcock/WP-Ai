...
namespace AIKit\Dependencies\duzun;
...
// ------------------------------------------------------------------------
class_exists('AIKit\Dependencies\duzun\\hQuery\\HTML_Index', false) or require_once __DIR__ . DIRECTORY_SEPARATOR . 'hQuery' . DIRECTORY_SEPARATOR . 'HTML_Index.php';
...
// ------------------------------------------------------------------------
// PSR-0 alias
class_exists('hQuery', false) or class_alias('AIKit\Dependencies\duzun\\hQuery', 'hQuery', false);
